  ...
  <b-container fluid="sm">
    <b-row class="text-left">
      ...
      <b-col>
        ...
        <p align="justify">First of all, and contrary to popular belief, aging is not universal. A number of complex species, such as lobsters, rockfishes, and tortoises, <a href="aging_animals.html">do not show signs of aging</a>. Therefore, aging is not a prerequisite to life. Aging is neither inevitable nor universal.</p>
        ...
        <p align="justify">Lastly, very few seem to oppose fighting the individual <a href="aging_definition.html">features of aging</a>. In other words, aging entails a number of pathologies, like cancer, heart disease, stroke and neurodegenerative diseases, whose cure is widely seen as desirable. Similarly, aging involves increased frailty and debilitation as well as functional declines of many types (e.g., declines in senses like audition and vision, and cognitive decline); research into how to delay and stop these is no doubt seen as positive. Therefore, it seems that fighting the individual <a href="aging_definition.html">components of aging</a> raises little opposition yet fighting them all together raises discording voices and is seen as unnatural.  As <a href="genetics_of_aging.html">discussed elsewhere</a>, targeting the aging process as a whole makes more sense than targeting age-related diseases and changes one by one (de Magalhaes, 2014a). But the end result will be the same whether we cure aging by curing it as a whole or by targeting its features one by one. And it will still be an unnatural outcome.</p>
        </div>
        <div ref="2">
        ...
        <p align="justify">No, of course not. In fact, curing aging and extending healthy lifespan would be profitable for nations. The economic value of increased longevity from   1970 to 2000 was estimated at $3.2 trillion per year for the US alone through  greater productivity and lower healthcare costs; economic benefits from future health improvements have also been estimated to be large (Murphy and Topel, 2006). Presently, the greatest burden on healthcare comes from the elderly and the trend is for expenses with old age to increase as the percentage of people over 65 years-old rises worldwide (<a href="http://www.un.org/esa/socdev/ageing/">UN Programme on Ageing</a>). If aging is not tackled, societies in the 21<sup>st</sup> will consist of a large proportion of frail, elderly people, which will result in a serious financial burden (Schneider, 1999). Therefore, curing aging would be economically sound. People would live longer but also work longer and thus be more productive. Without the declining years of old age, healthcare and the economy would benefit significantly from a cure for aging.</p>
        ...
        <p align="justify">Aging is the major problem we face in modern society. It is or will be the <a href="death_and_aging_fears.html">major cause of suffering</a> and pain for me and the ones I love. This holds true for most nations nowadays and that is why fighting aging must be a top priority.</p>
        </div>
        <div ref="11">
        ...
        <blockquote><p align="justify">"The Fountain of Youth: Cultural, Scientific, and Ethical Perspectives on a Biomedical Goal" edited by Post, SG and Binstock, RH (2004). Oxford University Press, New York.</p>
          ...
          <p align="justify">"The Scientific Conquest of Death: Essays on Infinite Lifespans" edited by the Immortality Institute (2004). Libros En Red, Buenos Aires. A book to which I contributed <a href="engineering_aging.html">a chapter</a>.</p></blockquote>
