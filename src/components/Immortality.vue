  ...
  <b-container fluid="sm">
    <b-row class="text-left">
      ...
      <b-col>
        ...
        <p align="justify">Assuming the initial mortality rate, the <a href="aging_definition.html">IMR</a>, of a typical population in an industrialized nation (0.0005/year) we have t<sub>0.5</sub> = 1,200 years. Using a lower IMR of 0.0002/year--see previous <a href="aging_definition.html">calculations</a>--gives t<sub>0.5</sub> = 3,500 years. Of course this assumes a constant IMR, which may not be the case if there are wars or pests that increase the IMR or, conversely, advances in other areas like transportation that decrease the IMR. Even so, this is at least a 15-fold increase in average lifespan. Maximum lifespan would be over 20,000 years, though again this is extraordinarily hard to predict given the radical changes in society, technology, lifestyle, etc. that may occur over a period spanning thousands of years.</p>
